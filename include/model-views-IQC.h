...
namespace rs2
{
    ...
    public:
		...
		//cary_add
		void display_3d_view(const rect& view_rect);
		//cary_add
		...
		void enableFilter(bool enable) { applyFilter = enable; }
    ...
    private:
		...
		std::shared_ptr<rs2::disparity_transform> disparity_2_depth = std::make_shared<rs2::disparity_transform>(false);
		std::shared_ptr<rs2::spatial_filter> spatialFilter = std::make_shared<rs2::spatial_filter>();
		std::shared_ptr<rs2::decimation_filter> decimationFilter = std::make_shared<rs2::decimation_filter>();
		std::shared_ptr<rs2::temporal_filter> temporalFilter = std::make_shared<rs2::temporal_filter>();
		std::shared_ptr<rs2::disparity_transform> depth_2_disparity = std::make_shared<rs2::disparity_transform>();
